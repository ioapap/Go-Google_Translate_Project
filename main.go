...
import (
	...
	cli "github.com/ioapap/Google_Translate_Project/CLI"
)
...
func init() {
	//flag can have bool, string etc. in this case we have taken stringVar so store value in sourceLang
	flag.StringVar(&sourceLang, "s", "en", "Source language[en]")
	//t is the parameter for target language, default is id
...
func main() {
	...
	//we are implementing concurrency here because we whenever call APIs, and if we want to call APIs multiple
